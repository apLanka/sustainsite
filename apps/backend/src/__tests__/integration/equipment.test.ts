...
describe('Equipment Management API', () => {
    ...
    describe('GET /api/resources/equipment', () => {
        beforeEach(async () => {
            ...
            await Equipment.create({ ...validEquipmentData, equipmentName: 'Crane X500', equipmentType: 'Crane', serialNumber: 'CRANE-2024-002', assetId: 'AST-002' });
        });
    ...
    describe('GET /api/resources/equipment/list/available', () => {
        beforeEach(async () => {
            await Equipment.create(validEquipmentData);
            await Equipment.create({ ...validEquipmentData, equipmentName: 'Used Excavator', status: 'In Use', serialNumber: 'USED-001', assetId: 'AST-003' });
        });
