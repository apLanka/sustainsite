...
documentSchema.methods.addAccessLog = function (userId: mongoose.Types.ObjectId, action: AccessAction) {
    this.accessLog.push({
        userId,
        action,
        timestamp: new Date(),
...
documentSchema.methods.createNewVersion = function (fileUrl: string, uploadedBy: mongoose.Types.ObjectId) {
