...
export interface IMaterial extends Document {
    ...
    recordUsage(quantity: number, usedBy: mongoose.Types.ObjectId, purpose?: string): Promise<IMaterial>;
}
...
materialSchema.methods.recordUsage = async function (quantity: number, usedBy: mongoose.Types.ObjectId, purpose?: string): Promise<IMaterial> {
