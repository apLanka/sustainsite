...
import { createMaterial, getMaterials, getMaterialById, updateMaterial, deleteMaterial, updateMaterialStatus, recordMaterialUsage, getLowStockMaterials, getCostSummary, } from '../controllers/resource.controller';
...
router.put('/:id/status', authenticate, authorize(UserRole.ADMIN, UserRole.PROJECT_MANAGER, UserRole.SUPPLIER), updateMaterialStatus);
