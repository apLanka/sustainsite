...
const JAMES = new mongoose.Types.ObjectId('69d909e359250aecadad7eb3');
const EMILY = new mongoose.Types.ObjectId('69d90a0e59250aecadad7f02');
const MICHAEL = new mongoose.Types.ObjectId('69d90a3859250aecadad7f1d');
const SARAH = new mongoose.Types.ObjectId('69d90a6d59250aecadad7f38');
const DANIEL = new mongoose.Types.ObjectId('69d90a8b59250aecadad7f53');
const OLIVIA = new mongoose.Types.ObjectId('69d90aca59250aecadad7f78');
const daysAgo = (n: number) => new Date(Date.now() - n * 86400000);
const daysFrom = (n: number) => new Date(Date.now() + n * 86400000);
async function seed() {
    ...
    await mongoose.connection.collection('users').updateOne({ _id: DANIEL }, { $set: { supplierId: sup1._id } });
    ...
    await mongoose.connection.collection('users').updateOne({ _id: EMILY }, { $set: { assignedProjects: [proj1._id, proj3._id] } });
    await mongoose.connection.collection('users').updateOne({ _id: MICHAEL }, { $set: { assignedProjects: [proj2._id, proj3._id] } });
    await mongoose.connection.collection('users').updateOne({ _id: SARAH }, { $set: { assignedProjects: [proj1._id, proj2._id, proj3._id] } });
    await mongoose.connection.collection('users').updateOne({ _id: OLIVIA }, { $set: { assignedProjects: [proj1._id, proj2._id] } });
    ...
    for (const m of verdantMetrics) {
        const metric = new SustainabilityMetric({
            ...
            recordedBy: EMILY,
            notes: `Monthly environmental audit — ${new Date(Date.now() - m.month * 86400000).toLocaleString('en-US', { month: 'long', year: 'numeric' })}`,
        });
        await metric.save();
    }
    ...
    await Material.insertMany([
        ...
        },
        {
            ...
            suggestedReorderQuantity: 10000,
            sustainabilityRating: 5,
            isEcoFriendly: false,
            recycledContent: 15,
            certifications: [],
    ...
    await Equipment.insertMany([
        {
            ...
            depreciationRate: 10,
            rentalRatePerDay: 85000,
            currentLocation: 'Verdant Tower — Tower crane base Level B1',
            maintenanceHistory: [
                { maintenanceDate: daysAgo(30), maintenanceType: 'Routine', description: 'Monthly inspection — greasing, wire rope check, limit switch test.', cost: 45000, performedBy: 'Liebherr Lanka Service', nextMaintenanceDate: daysFrom(60) },
                { maintenanceDate: daysAgo(90), maintenanceType: 'Routine', description: 'Quarterly service — full mechanical inspection and load test.', cost: 120000, performedBy: 'Liebherr Lanka Service', nextMaintenanceDate: daysAgo(30) },
            ],
            assignmentHistory: [
        ...
        },
        {
            ...
            depreciationRate: 8,
            rentalRatePerDay: 55000,
            currentLocation: 'Riverside Eco-Residences — Excavation area',
            maintenanceHistory: [
                { maintenanceDate: daysAgo(15), maintenanceType: 'Routine', description: '250-hour service — oil change, filter replacement, track inspection.', cost: 38000, performedBy: 'CAT Lanka', nextMaintenanceDate: daysFrom(45) },
            ],
            assignmentHistory: [
                { projectId: proj3._id, assignedDate: daysAgo(290), returnedDate: daysAgo(100), operatorId: MICHAEL, hoursUsed: 820, fuelConsumed: 12500 },
                { projectId: proj2._id, assignedDate: daysAgo(85), operatorId: MICHAEL, hoursUsed: 340, fuelConsumed: 5200 },
            ],
        },
        {
            ...
            maintenanceHistory: [
                { maintenanceDate: daysAgo(45), maintenanceType: 'Repair', description: 'Replaced worn piston seals and delivery cylinder. Pressure tested to 85 bar.', cost: 95000, performedBy: 'Schwing Lanka', nextMaintenanceDate: daysFrom(15) },
            ],
            assignmentHistory: [
        ...
        },
        {
            ...
            depreciationRate: 10,
            rentalRatePerDay: 48000,
            currentLocation: 'Equipment yard — Colombo depot',
            maintenanceHistory: [
                { maintenanceDate: daysAgo(10), maintenanceType: 'Overhaul', description: 'Major overhaul — engine rebuild, track replacement, hydraulic system service.', cost: 380000, performedBy: 'Komatsu Lanka', nextMaintenanceDate: daysFrom(80) },
            ],
            assignmentHistory: [
                { projectId: proj3._id, assignedDate: daysAgo(295), returnedDate: daysAgo(20), operatorId: MICHAEL, hoursUsed: 1450, fuelConsumed: 28000 },
            ],
        ...
        },
        {
            ...
            depreciationRate: 8,
            rentalRatePerDay: 28000,
            currentLocation: 'Riverside Eco-Residences — Batching plant',
            maintenanceHistory: [
                { maintenanceDate: daysAgo(20), maintenanceType: 'Routine', description: 'Drum inspection, water system flush, hydraulic oil change.', cost: 22000, performedBy: 'In-house', nextMaintenanceDate: daysFrom(40) },
            ],
            assignmentHistory: [
