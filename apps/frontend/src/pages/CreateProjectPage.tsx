        ...
        <header className="py-10 space-y-4">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm font-medium mt-2 max-w-2xl text-balance">
              Initialize a new sustainable construction project by defining its scope, budget, and
              location. This data will form the baseline for sustainability monitoring and resource
              management.
            </p>
          </div>
        </header>
