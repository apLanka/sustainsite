      ...
      <div className="px-10 py-10 pb-20 space-y-8">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {(filterRisk || filterStatus || filterResolved) && (
            <button onClick={() => { setFilterRisk(''); setFilterStatus(''); setFilterResolved(''); setPage(1); }}
        ...
        <div className="bg-surface-container-lowest rounded-2xl border border-slate-100/50 shadow-sm overflow-hidden">
          {isLoading ? (
            ...
            <div className="py-16 text-center">
              ...
              {canManage && (
                <button onClick={() => setShowCreate(true)} className="mt-4 text-xs font-bold text-emerald-600 hover:underline">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2 justify-end">
                        ...
                        {canManage && (
                          <>
                            {!insp.isResolved && (
                              <button onClick={() => handleMarkResolved(insp)} className="text-slate-400 hover:text-emerald-600 transition-colors" title="Mark resolved">
          ...
          <div className="bg-white rounded-[32px] w-full max-w-xl relative overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8 space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {Object.values(RiskLevel).map(r => (
                    <button key={r} type="button" onClick={() => setForm(f => ({ ...f, riskLevel: r }))}
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input type="text" className="input-standard flex-1 h-9 text-xs" placeholder="Add a recommended action" value={newAction} onChange={e => setNewAction(e.target.value)}
                    onKeyDown={e => {
          ...
          <div className="bg-white rounded-[32px] w-full max-w-lg relative overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8 space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {Object.values(RiskLevel).map(r => (
                    <button key={r} type="button" onClick={() => setEditForm(f => ({ ...f, riskLevel: r }))}
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {Object.values(ActionStatus).map(s => (
                    <button key={s} type="button" onClick={() => setEditForm(f => ({ ...f, actionStatus: s }))}
