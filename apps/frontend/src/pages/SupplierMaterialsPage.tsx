  ...
  return (
    <DashboardLayout>
      <header className="py-10">
        ...
        <h2 className="text-4xl font-extrabold text-primary tracking-tighter font-headline">
          Materials &amp; orders
        </h2>
        <p className="text-slate-500 text-sm font-medium mt-2 max-w-2xl">
          Purchase orders and deliveries linked to your supplier account. Update delivery status as
          shipments progress.
        </p>
      </header>
        ...
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-sm text-slate-400 mt-2">
              No materials are linked to your supplier profile yet.
            </p>
          </div>
        ) : (
