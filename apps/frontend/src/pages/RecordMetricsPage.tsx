        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {recentMetrics.map((metric) => (
              <div key={metric._id} onClick={() => navigate(`/projects/${projectId}/sustainability`)} className="flex justify-between items-center p-3 rounded-xl hover:bg-slate-50 transition-all group cursor-pointer border border-transparent hover:border-slate-100">
                <div>
