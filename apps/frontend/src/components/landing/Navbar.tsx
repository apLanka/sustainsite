...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 w-full flex justify-between items-center px-6 lg:px-12 h-16 transition-all duration-300 z-50 font-headline tracking-tight border-b ${isScrolled ? 'bg-white/80 backdrop-blur-md border-surface-container shadow-sm' : 'bg-transparent border-transparent'}`}
    >
