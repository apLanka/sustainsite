      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 space-y-4 text-center lg:text-left">
          <h2 className="text-4xl font-headline font-bold text-primary">
            Advanced Sustainable Intelligence
          </h2>
          <p className="text-on-surface-variant max-w-2xl font-medium">
            Every module in SustainSite is engineered to balance structural integrity with
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          >
            <div>
              ...
              <p className="text-on-surface-variant font-medium">
                Monitor embodied carbon across your supply chain in real-time. Automated reporting
                for ESG compliance and local regulations.
              </p>
            </div>
          ...
          <motion.div
            whileHover={{ y: -5 }}
            className="bg-primary p-8 rounded-3xl flex flex-col justify-between text-white min-h-[320px]"
          >
            ...
            <div>
              ...
              <p className="text-white/70 text-sm font-medium">
                Automated LEED and BREEAM certification workflows with smart contract triggers.
              </p>
            </div>
            <button
          ...
          >
            ...
            <p className="text-on-surface-variant text-sm font-medium mb-auto">
              End-to-end transparency for circular economy materials and sustainable sourcing.
            </p>
          ...
          <motion.div
            whileHover={{ y: -5 }}
            className="md:col-span-1 lg:col-span-1 bg-secondary-container p-8 rounded-3xl min-h-[320px] flex flex-col justify-between"
          >
            ...
            <div>
              ...
              <p className="text-primary/70 text-sm font-medium">
                Link green performance directly to financial incentives and tax credits.
              </p>
            </div>
          </motion.div>
