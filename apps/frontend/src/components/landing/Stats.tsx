    ...
    <section className="py-24 px-6 lg:px-12 bg-white">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          ...
          {[
            ...
            <div key={i} className="space-y-2">
              <motion.span
                ...
                className="text-5xl font-headline font-extrabold text-primary block"
              >
                {stat.value}
              </motion.span>
        ...
        <motion.div
          ...
          className="lg:w-1/2 p-12 bg-surface-container-low rounded-[2.5rem] relative"
        >
          ...
          <blockquote className="text-2xl font-headline italic text-primary leading-tight font-medium">
            "SustainSite has transformed how we approach infrastructure. It's no longer just about
            building taller, but building smarter and kinder to the planet."
          </blockquote>
          <div className="mt-10 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-on-surface-variant font-medium">
                Director of Innovation, Sustainable Infrastructure Corp
              </p>
            </div>
          </div>
        </motion.div>
