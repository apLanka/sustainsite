    ...
    scoreCategory === 'Green'
      ...
      : scoreCategory === 'Yellow'
        ...
        : scoreCategory === 'Red'
          ...
          : 'PENDING';
  const rankIcon =
    scoreCategory === 'Green' ? 'award_star' : scoreCategory === 'Yellow' ? 'star_half' : 'warning';
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-emerald-950 rounded-3xl shadow-xl shadow-emerald-950/20 relative overflow-hidden group h-full">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 w-full border-t border-emerald-900/50 pt-8">
        <div>
          <p className="text-[9px] font-black uppercase tracking-widest text-emerald-500 mb-1 leading-none">
            Net Impact
          </p>
          <div className="flex items-center gap-1.5">
            <span
              className="material-symbols-outlined text-emerald-300 text-sm"
