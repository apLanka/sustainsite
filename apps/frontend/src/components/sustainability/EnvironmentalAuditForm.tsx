...
const EnvironmentalAuditForm = () => {
    ...
    return (<form onSubmit={handleSubmit} className="space-y-12">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-2">
            ...
            <input type="date" value={form.recordedDate} onChange={e => update('recordedDate', e.target.value)} className="input-standard w-full h-12 cursor-pointer"/>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-2">
            ...
            <input type="number" placeholder="0.00" min="0" step="0.01" className="input-standard w-full h-12" value={form.carbonTransportation || ''} onChange={e => update('carbonTransportation', Number(e.target.value))}/>
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Equipment</label>
            <input type="number" placeholder="0.00" min="0" step="0.01" className="input-standard w-full h-12" value={form.carbonEquipment || ''} onChange={e => update('carbonEquipment', Number(e.target.value))}/>
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Materials</label>
            <input type="number" placeholder="0.00" min="0" step="0.01" className="input-standard w-full h-12" value={form.carbonMaterials || ''} onChange={e => update('carbonMaterials', Number(e.target.value))}/>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-2">
            ...
            <input type="number" placeholder="0.00" min="0" className="input-standard w-full h-12" value={form.electricity || ''} onChange={e => update('electricity', Number(e.target.value))}/>
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Diesel / Fuel (Liters)</label>
            <input type="number" placeholder="0.00" min="0" className="input-standard w-full h-12" value={form.diesel || ''} onChange={e => update('diesel', Number(e.target.value))}/>
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Renewable Offset (%)</label>
            <input type="number" placeholder="0" min="0" max="100" className="input-standard w-full h-12" value={form.renewableOffset || ''} onChange={e => update('renewableOffset', Number(e.target.value))}/>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-2">
            ...
            <div className="relative">
              <input type="number" placeholder="0.00" min="0" className="input-standard w-full h-12" value={form.waterConsumption || ''} onChange={e => update('waterConsumption', Number(e.target.value))}/>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input type="number" placeholder="0.00" min="0" className="input-standard w-full h-12" value={form.waterRecycled || ''} onChange={e => update('waterRecycled', Number(e.target.value))}/>
              <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-black text-slate-300">LITERS</span>
            </div>
          </div>
          <div className="space-y-2">
            ...
            <div className="relative">
              <input type="number" placeholder="0.00" min="0" className="input-standard w-full h-12" value={form.recyclableWaste || ''} onChange={e => update('recyclableWaste', Number(e.target.value))}/>
          ...
          <div className="space-y-2">
            ...
            <input type="number" placeholder="0.00" min="0" className="input-standard w-full h-12" value={form.nonRecyclableWaste || ''} onChange={e => update('nonRecyclableWaste', Number(e.target.value))}/>
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Hazardous Materials (kg)</label>
            <input type="number" placeholder="0.00" min="0" className="input-standard w-full h-12" value={form.hazardousWaste || ''} onChange={e => update('hazardousWaste', Number(e.target.value))}/>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <textarea placeholder="Describe any anomalies or mitigation efforts taken during this audit cycle..." rows={5} className="input-standard w-full resize-none h-40" value={form.notes} onChange={e => update('notes', e.target.value)}/>
      </section>

      
      <div className="flex flex-col sm:flex-row gap-4 pt-10 border-t border-slate-100">
        <button type="submit" disabled={isSubmitting} className="flex-1 bg-primary text-white font-bold py-4 rounded-xl shadow-xl shadow-primary/20 hover:brightness-110 active:scale-95 transition-all font-headline tracking-widest uppercase text-xs cursor-pointer disabled:opacity-60">
          {isSubmitting ? 'Submitting...' : 'Verify & Submit Audit'}
        </button>
        <button type="button" onClick={() => navigate(`/projects/${projectId}/sustainability`)} className="px-10 py-4 bg-surface-container-low text-primary font-bold rounded-xl hover:bg-slate-200 transition-all font-headline tracking-widest uppercase text-xs cursor-pointer">
          Cancel
        </button>
      </div>
    </form>);
