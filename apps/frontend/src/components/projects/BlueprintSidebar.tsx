      ...
      <div className="bg-emerald-950 text-white p-8 rounded-3xl shadow-xl shadow-emerald-950/20 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h4 className="text-[10px] font-black uppercase tracking-widest text-secondary-container">Sustainability Pulse</h4>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-[10px] text-emerald-100/50 leading-relaxed italic">
              "Integrating high-efficiency HVAC and solar orientation can improve this score by up to 14%."
            </p>
          </div>
        </div>
      </div>
        ...
        <ul className="space-y-6">
          <li className="flex gap-4 group">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed font-medium">Ensure the project orientation maximizes natural lighting for reduced energy load.</p>
            </div>
          </li>
          ...
          <li className="flex gap-4 group">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed font-medium">Define a baseline for water consumption monitoring during the site prep phase.</p>
            </div>
          </li>
          ...
          <li className="flex gap-4 group">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed font-medium">Refer to section 4B of the ESG handbook for material procurement standards.</p>
            </div>
          </li>
        </ul>
