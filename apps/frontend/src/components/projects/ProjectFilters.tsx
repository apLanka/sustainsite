...
const ProjectFilters = () => {
    ...
    return (<div className="flex flex-col sm:flex-row gap-4 w-full mb-8">
      <div className="relative group flex-1">
        ...
        <input className="input-standard w-full pl-10 pr-4 h-11" placeholder="Search Project Inventory..." type="text" value={searchInput} onChange={handleSearch}/>
      </div>

      <div className="relative w-full sm:w-64 group">
        <select className="input-standard w-full pl-4 pr-10 h-11 appearance-none cursor-pointer uppercase tracking-widest" value={filters.status} onChange={handleStatus}>
