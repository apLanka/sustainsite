            ...
            {isProfileOpen && (
              ...
              >
                <div className="p-5 border-b border-slate-50 bg-slate-50/50">
                  <p className="text-sm font-black text-primary truncate leading-none mb-1">
                    {userName}
                  </p>
                ...
                <div className="p-2">
                  ...
                  >
                    <span className="material-symbols-outlined text-xl text-slate-400 group-hover:text-secondary">
                      settings
                    </span>
                    Settings
                  </Link>
                ...
                <div className="p-2 border-t border-slate-50">
                  ...
                  >
                    <span className="material-symbols-outlined text-xl text-rose-400 group-hover:text-rose-500">
                      logout
                    </span>
                    Log Out
                  </button>
