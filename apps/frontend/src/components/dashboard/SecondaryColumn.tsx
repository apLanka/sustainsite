    ...
    <div className="space-y-6">
      ...
      <div className="bg-surface-container-lowest rounded-2xl border border-slate-100/50 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
          ...
          <Link
            to={upcomingDueDates.length > 0 ? `/projects/${(upcomingDueDates as ComplianceChecklist[])[0].projectId}/compliance` : '/projects'}
        ...
        {upcomingDueDates.length === 0 ? (
          ...
          <div className="divide-y divide-slate-50">
            {(upcomingDueDates as ComplianceChecklist[]).map((checklist) => {
              ...
              return (
                <div key={checklist._id} className="px-6 py-3.5 flex items-center justify-between gap-3 hover:bg-slate-50 transition-colors">
                  <div className="flex-1 min-w-0">
