        ...
        <div className="lg:col-span-2 bg-white border border-slate-100 rounded-[32px] p-8 shadow-sm relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
            <div>
              ...
              <h3 className="text-4xl font-black text-primary tracking-tighter">
                ...
                <span className="text-slate-300 text-lg font-bold ml-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
              ...
              <span className="text-primary bg-slate-50 px-3 py-1 rounded-lg border border-slate-100">
                {percentage.toFixed(1)}% Budget Utilized
              </span>
                    ...
                    <div key={item.category} className="group cursor-help">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-primary font-black text-xs tabular-nums">
                          {safeNumber(item.percentage).toFixed(1)}%
                        </span>
                      </div>
