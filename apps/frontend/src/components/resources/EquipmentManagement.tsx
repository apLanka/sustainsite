...
export default function EquipmentManagement() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const res = await resourcesApi.createEquipment({
        ...payload,
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 text-xs font-bold mt-1">
            Real-time tracking and maintenance scheduling
          </p>
        </div>
        {canMutate && (
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {equipment.map((item) => (
          <div
            key={item._id}
            className="bg-white border border-slate-100 rounded-[32px] p-8 shadow-sm hover:-translate-y-1 transition-all group relative overflow-hidden"
          >
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="w-14 h-14 rounded-2xl bg-slate-50 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-all duration-500">
                <span className="material-symbols-outlined text-2xl">
                  {item.equipmentType === 'Crane'
                    ? 'construction'
                    : item.equipmentType === 'Loader'
                      ? 'forklift'
            ...
            <div className="mb-6">
              <h4 className="text-primary font-black text-xl mb-1 tracking-tight">
                {item.equipmentName}
              </h4>
                ...
                <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
                  ...
                  <span
                    className={
                      ...
                      new Date(item.nextScheduledMaintenance).getTime() <
                  ...
                  >
                    {item.nextScheduledMaintenance
                      ? new Date(item.nextScheduledMaintenance).toLocaleDateString()
                      : '—'}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {canMutate && (
                  <button
                    ...
                    className="flex-1 py-2 text-[10px] font-black uppercase tracking-wider bg-slate-50 text-slate-600 rounded-xl hover:bg-primary hover:text-white transition-all flex items-center justify-center gap-1"
                  >
                ...
                {canMutate && (
                  <button
                    ...
                    className="flex-1 py-2 text-[10px] font-black uppercase tracking-wider bg-amber-50 text-amber-700 rounded-xl hover:bg-amber-100 transition-all flex items-center justify-center gap-1"
                  >
                ...
                {canMutate &&
                  ...
                  activeProjectId &&
                  item.currentProjectId !== activeProjectId && (
                    <button
                      onClick={() => handleAssign(item)}
                      className="flex-1 py-2 text-[10px] font-black uppercase tracking-wider bg-emerald-50 text-emerald-700 rounded-xl hover:bg-emerald-100 transition-all flex items-center justify-center gap-1"
                    >
                ...
                {canDel && (
                  <button
                    ...
                    className="w-9 h-9 rounded-xl bg-rose-50 text-rose-500 hover:bg-rose-100 transition-all flex items-center justify-center"
                  >
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-slate-400 text-[10px] mt-1 font-bold">
                Register heavy machinery or transport vehicles
              </p>
            </div>
          </button>
        )}
            ...
            <div className="p-10 space-y-5 max-h-[70vh] overflow-y-auto">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setForm((f) => ({ ...f, equipmentType: e.target.value as EquipmentType }))
                  }
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((f) => ({ ...f, rentalRatePerDay: Number(e.target.value) }))
                    }
                  />
                </div>
              </div>
            ...
            <div className="p-10 space-y-5 max-h-[70vh] overflow-y-auto">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  onChange={(e) => setEditForm((f) => ({ ...f, equipmentName: e.target.value }))}
                />
              </div>
              <div className="space-y-1.5">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setEditForm((f) => ({
                      ...f,
                      status: e.target.value as EquipmentAsset['status'],
                    }))
                  }
                >
                  {['Available', 'In Use', 'Under Maintenance', 'Damaged', 'Retired'].map((s) => (
              ...
              <div className="space-y-1.5">
                ...
                <input
                  type="date"
                  className="input-standard w-full h-12 cursor-pointer"
                  value={editForm.nextScheduledMaintenance ?? ''}
                  onChange={(e) =>
                    setEditForm((f) => ({ ...f, nextScheduledMaintenance: e.target.value }))
                  }
                />
              </div>
              <div className="space-y-1.5">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          <div className="bg-white rounded-[40px] w-full max-w-md relative overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
            <div className="bg-amber-600 p-8 text-white">
              ...
              <p className="text-amber-200 text-xs font-bold uppercase tracking-widest mt-2 truncate">
                {showMaintenanceModal.equipmentName}
              </p>
            </div>
            <div className="p-10 space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMaintenanceForm((f) => ({ ...f, maintenanceDate: e.target.value }))
                    }
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setMaintenanceForm((f) => ({
                        ...f,
                        maintenanceType: e.target.value as 'Routine' | 'Repair' | 'Overhaul',
                      }))
                    }
                  >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMaintenanceForm((f) => ({ ...f, cost: Number(e.target.value) }))
                    }
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMaintenanceForm((f) => ({ ...f, nextMaintenanceDate: e.target.value }))
                    }
                  />
                </div>
              </div>
              <div className="flex gap-4 pt-2">
                <button
                  ...
                  className="flex-1 py-4 bg-slate-100 text-primary font-bold rounded-2xl hover:bg-slate-200 transition-all cursor-pointer disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
          ...
          <div className="bg-white rounded-[32px] w-full max-w-sm relative overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-8 space-y-5">
              <p className="text-sm text-slate-600">
                Are you sure you want to remove this equipment from the fleet?
              </p>
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="flex-[2] py-3 bg-rose-600 text-white font-black rounded-2xl hover:brightness-110 active:scale-95 transition-all"
                >
                  Remove
                </button>
              </div>
