    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="bg-rose-50 border border-rose-100 p-4 rounded-xl flex items-center gap-3 text-rose-700">
          ...
          <div>
            ...
            <p className="text-xs opacity-80">
              Some materials are below minimum thresholds. Immediate procurement recommended.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-sm">
        <div className="p-6 border-b border-slate-100 flex items-center justify-between">
          <h4 className="text-primary font-black uppercase tracking-widest text-xs">
            Material Ledger
          </h4>
          {canCreateEdit && (
            <button
                ...
                {materials.map((m) => (
                  <tr key={m._id} className="hover:bg-slate-50/50 transition-colors group">
                    <td className="px-6 py-5">
                      ...
                      <div className="text-[10px] text-slate-400 uppercase font-black tabular-nums">
                        ID: {m._id.slice(-8)}
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-baseline gap-1">
                        <span
                          className={`text-base font-black tabular-nums ${m.currentStock < m.minimumThreshold ? 'text-rose-600' : 'text-primary'}`}
                        >
                          {m.currentStock}
                        </span>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {canDeleteMat && (
                            <button
                              ...
                              className="w-8 h-8 rounded-lg bg-slate-50 text-slate-400 hover:bg-rose-500 hover:text-white transition-all flex items-center justify-center"
                              title="Delete"
                            >
            ...
            <div className="p-10 space-y-5 max-h-[70vh] overflow-y-auto">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setForm((f) => ({ ...f, category: e.target.value as MaterialCategory }))
                  }
                >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((f) => ({ ...f, minimumThreshold: Number(e.target.value) }))
                  }
                />
              </div>
              <div className="space-y-1.5">
            ...
            <div className="p-10 space-y-5 max-h-[70vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm((f) => ({ ...f, unitPrice: Number(e.target.value) }))
                    }
                  />
                </div>
              </div>
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setEditForm((f) => ({
                      ...f,
                      status: e.target.value as MaterialAsset['status'],
                    }))
                  }
                >
                  {['Ordered', 'In Transit', 'Delivered', 'In Stock', 'Used', 'Cancelled'].map(
                    (s) => (
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditForm((f) => ({ ...f, minimumThreshold: Number(e.target.value) }))
                  }
                />
              </div>
              <div className="flex items-center gap-3">
                <input
                  ...
                  id="editEco"
                  className="w-5 h-5 accent-primary cursor-pointer"
                  checked={editForm.isEcoFriendly ?? false}
                  onChange={(e) => setEditForm((f) => ({ ...f, isEcoFriendly: e.target.checked }))}
                />
                <label
                  htmlFor="editEco"
                  className="text-sm font-medium text-slate-600 cursor-pointer"
          ...
          <div className="bg-white rounded-[32px] w-full max-w-sm relative overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-8 space-y-5">
              <p className="text-sm text-slate-600">
                Are you sure you want to remove this material from inventory?
              </p>
