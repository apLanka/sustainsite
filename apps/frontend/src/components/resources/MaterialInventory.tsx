...
const mockMaterials: MaterialAsset[] = [
  {
    id: 'm1',
    projectId: 'p1',
    ...
    unit: 'Tons',
    status: 'In Stock',
    supplierName: 'EcoBuild Supplies',
    minThreshold: 50,
  ...
  },
  {
    ...
    unit: 'Units',
    status: 'In Transit',
    supplierName: 'GreenForest Logistics',
    minThreshold: 40,
...
export default function MaterialInventory() {
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {mockMaterials.some(m => m.status === 'Low Stock' || m.quantity < m.minThreshold) && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border border-slate-100 p-6 rounded-3xl shadow-sm">
          ...
          <h3 className="text-3xl font-black text-primary tracking-tighter">335 <span className="text-slate-400 text-sm font-bold uppercase tracking-widest">Total Units</span></h3>
        </div>
        ...
        <div className="bg-white border border-slate-100 p-6 rounded-3xl shadow-sm">
          ...
          <h3 className="text-3xl font-black text-emerald-600 tracking-tighter">82% <span className="text-emerald-400 text-sm font-bold uppercase tracking-widest">Green Score</span></h3>
        </div>
        ...
        <div className="bg-primary text-white p-6 rounded-3xl shadow-lg ring-4 ring-primary/5">
          ...
          <h3 className="text-3xl font-black text-white tracking-tighter">04 <span className="text-white/40 text-sm font-bold uppercase tracking-widest">In Transit</span></h3>
        </div>
      </div>
